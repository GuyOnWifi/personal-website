...
export default function Hero() {
    ...
    // a
    const aPath = "M 420 260 L 380 260 L 370 220 L 410 190 L 440 220 L 430 260 M 440 220 L 450 260";
    ...
    return (
        <div className="relative h-screen w-full overflow-hidden bg-gradient-to-b from-[#283655] to-[#b3a8d6]">
            {/* Background Stars */}
            {stars.map((star) => (
